    ...
    for (unsigned int i = 0; i < meshes.size(); i++) {
        ...
        switch (material->mType) {
            case MaterialType::PhongMaterial: {
                ...
                //光源参数的uniform更新
                shader->setVec3("directionalLight.direction", light->mDirection);
                shader->setVec3("directionalLight.color", light->mColor);
                shader->setFloat("directionalLight.specularIntensity", light->mSpecularIntensity);
